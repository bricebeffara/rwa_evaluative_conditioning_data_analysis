...
marg_cc1neg <- marginal_effects(double_resp, effects = "RWAscore", ordinal = TRUE, 
...
marg_cc1pos <- marginal_effects(double_resp, effects = "RWAscore", ordinal = TRUE, 
...
marg_cc2neg <- marginal_effects(double_resp, effects = "RWAscore", ordinal = TRUE, 
...
marg_cc2pos <- marginal_effects(double_resp, effects = "RWAscore", ordinal = TRUE, 
...
# marg_all
# ggsave("plots/marg_xp07_french.jpg", width = 50, height = 30, units = "cm")
# ggsave("plots/marg_xp07_french.pdf", width = 50, height = 30, units = "cm")
# ggsave("plots/marg_xp07_french.tex", width = 50, height = 30, units = "cm")
