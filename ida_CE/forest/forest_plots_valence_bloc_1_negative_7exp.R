...
data7int<- data.frame( value = c(posterior_samples(ec01rwaP, "b")$"b_rwa",
                                 posterior_samples(ec02rwaP, "b")$"b_rwa",
                                 posterior_samples(ec03rwaP, "b")$"b_rwa",
                                 posterior_samples(ecAPTrwaN, "b")$"b_rwa",
                                 posterior_samples(ecAMPrwaN, "b")$"b_rwa",
                                 posterior_samples(ecIATrwaN, "b")$"b_rwa",
                                 posterior_samples(ecdoublerwaN, "b")$"b_rwa",
                                 posterior_samples(ecIDArwaN, "b")$"b_rwa"
),
...
h01rwus <- hypothesis (ec01rwaP, class = "b", "rwa = 0")
bf001rwus <- 1
...
h02rwus <- hypothesis (ec02rwaP, class = "b", "rwa = 0")
bf002rwus <- 1
...
h03rwus <- hypothesis (ec03rwaP, class = "b", "rwa = 0")
bf003rwus <- 1
...
hAPTrwus <- hypothesis (ecAPTrwaN, class = "b", "rwa = 0")
bf0APTrwus <- 1
...
hAMPrwus <- hypothesis (ecAMPrwaN, class = "b", "rwa = 0")
bf0AMPrwus <- 1
...
hIATrwus <- hypothesis (ecIATrwaN, class = "b", "rwa = 0")
bf0IATrwus <- 1
...
hdoublerwus <- hypothesis (ecdoublerwaN, class = "b", "rwa = 0")
bf0doublerwus <- 1
...
hIDArwus <- hypothesis (ecIDArwaN, class = "b", "rwa = 0")
bf0IDArwus <- 1
...
p1 <-
  ...
  labs(x = expression(beta[RWA["Block 1 negative"]]))+
