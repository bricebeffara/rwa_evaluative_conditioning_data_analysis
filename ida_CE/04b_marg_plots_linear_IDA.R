...
attr(marg_ida$`RWAscore:usvalence`, "spaghetti")$usvalence <- ifelse (attr(marg_ida$`RWAscore:usvalence`, "spaghetti")$usvalence < -0.5, "Negative", "Positive")
...
#    axis_title_size = 15
#  ) +
#  scale_fill_manual(values=alpha(c("#73a5ff", "#50ce76"),.3)) +
#  scale_color_manual(values= alpha(c("#73a5ff", "#50ce76"),.3), guide = "none") +
