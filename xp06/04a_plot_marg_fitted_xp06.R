# File name: 04a_plot_marg_fitted_xp06.R
# Online archive: gitlab
# Authors: Brice Beffara & Amélie Bret 
# Sat Sep  1 18:48:30 2018 ------------------------------
...
cond_ord1neg <- data.frame(order = -0.5, usvalencedir = -0.5,
                      cond__ = "order1_negative")

# !!order1!!stimuli with !!positive!! valence
cond_ord1pos <- data.frame(order = -0.5, usvalencedir = 0.5,
                      cond__ = "order1_positive")

# !!order2!!stimuli with !!negative!! valence
cond_ord2neg <- data.frame(order = 0.5, usvalencedir = -0.5,
                      cond__ = "order2_negative")

# !!order2!!stimuli with !!positive!! valence
cond_ord2pos <- data.frame(order = 0.5, usvalencedir = 0.5,
...
# marg_all
# ggsave("plots/marg_xp06_french.jpg", width = 50, height = 30, units = "cm")
# ggsave("plots/marg_xp06_french.pdf", width = 50, height = 30, units = "cm")
# ggsave("plots/marg_xp06_french.tex", width = 50, height = 30, units = "cm")
