...
direct_df$Valence <- ifelse (direct_df$usvalencedir == -0.5, "Négative", "Positive")

# level 1 plot -----------------------------------------------------------

direct_df_ordone <- subset(direct_df, order == -0.5)

data_plot_ordone = direct_df_ordone %>%
...
direct_df_ordtwo <- subset(direct_df, order == 0.5)

data_plot_ordtwo = direct_df_ordtwo %>%
  ggplot(aes(x = as.character(response), y = RWAscore,
             fill = Valence, color = Valence)) +
  geom_point(position = position_jitterdodge(jitter.width = 0.2, jitter.height = 0.05, 
                                             dodge.width = -0.75), alpha = 0.4, size = 1,
...
# data_plot_all
# ggsave("plots/data_xp06_french.jpg", width = 50, height = 15, units = "cm")
# ggsave("plots/data_xp06_french.pdf", width = 50, height = 15, units = "cm")
# ggsave("plots/data_xp06_french.tex", width = 50, height = 15, units = "cm")
...
# uncomment to display and save plot
# data_spag_all
# ggsave("plots/data_spag_xp06_french.jpg", width = 50, height = 30, units = "cm")
# ggsave("plots/data_spag_xp06_french.pdf", width = 50, height = 30, units = "cm")
# ggsave("plots/data_spag_xp06_french.tex", width = 50, height = 30, units = "cm")
