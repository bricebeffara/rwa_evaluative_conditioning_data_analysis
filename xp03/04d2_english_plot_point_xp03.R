...
bloc_df$Valence <- ifelse (bloc_df$usvalence2 == -0.5, "Negative", "Positive")
...
# uncomment to display and save plot
# data_spag_all
# ggsave("plots/data_spag_xp03_english.jpg", width = 50, height = 30, units = "cm")
# ggsave("plots/data_spag_xp03_english.pdf", width = 50, height = 30, units = "cm")
# ggsave("plots/data_spag_xp03_english.tex", width = 50, height = 30, units = "cm")
# data_spag_b1
# ggsave("plots/data_spag_b1_xp03_english.pdf", width = 25, height = 30, units = "cm")
# data_spag_b2
# ggsave("plots/data_spag_b2_xp03_english.pdf", width = 25, height = 30, units = "cm")
