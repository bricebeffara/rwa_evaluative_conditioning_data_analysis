...
base_df$Valence <- ifelse (base_df$usvalence == -0.5, "Negative", "Positive")
...
# uncomment to display and save plot
# data_spag_all
# ggsave("plots/data_spag_xp01_french.jpg", width = 25, height = 30, units = "cm")
# ggsave("plots/data_spag_xp01_english.pdf", width = 25, height = 30, units = "cm")
# ggsave("plots/data_spag_xp01_french.tex", width = 25, height = 30, units = "cm")
